...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '1874', // 您的昵称
  BIO: process.env.NEXT_PUBLIC_BIO || '有粤语歌就不会有世界末日', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.1874.cool', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, Blog', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'me@mail.1874.cool', // 邮箱地址
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/LetTTGACO', // 你的github个人主页
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '陕ICP备18013290号-3', // 备案号 闽ICP备XXXXXXX
  ...
  COMMENT_GISCUS_REPO: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO || 'LetTTGACO/blog.1874.cool', // 你的Github仓库名 e.g 'tangly1024/NotionNext'
  COMMENT_GISCUS_REPO_ID: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO_ID || 'R_kgDOJTxGWQ', // 你的Github Repo ID e.g ( 設定完 giscus 即可看到 )
  COMMENT_GISCUS_CATEGORY_ID: process.env.NEXT_PUBLIC_COMMENT_GISCUS_CATEGORY_ID || 'DIC_kwDOJTxGWc4CctpA', // 你的Github Discussions 內的 Category ID ( 設定完 giscus 即可看到 )
  COMMENT_GISCUS_MAPPING: process.env.NEXT_PUBLIC_COMMENT_GISCUS_MAPPING || 'title', // 你的Github Discussions 使用哪種方式來標定文章, 預設 'pathname'
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || "1874's BLOG", // 站点标题 ，被notion中的页面标题覆盖
  ...
  DESCRIPTION: process.env.NEXT_PUBLIC_DESCRIPTION || '有粤语歌就不会有世界末日', // 站点描述，被notion中的页面描述覆盖
