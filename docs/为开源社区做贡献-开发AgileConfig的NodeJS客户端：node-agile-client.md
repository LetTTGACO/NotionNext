...
![FnGZZCTPJNVUKA3cSKxwOv45nRzh.png](https://image.1874.cool/1874-blog-images/1c11354f362e08b2f5edbcb80b6a58f7.png)


我的想法是充分利用缓存，`node`使用端在需要时只需要读取本地的配置文件或者内存中的缓存即可拿到`json`文件。对于缓存的处理，如下图所示：


![Fi902QOqP5_v6kgBr4U5XnKHf_As.jpeg](https://image.1874.cool/1874-blog-images/4623eda78a2c0d961eef09319fa2ed98.jpeg)
...
![Fi8seFPwjcCvorcZxZY1A2bMTZz4.png](https://image.1874.cool/1874-blog-images/8493c6f3f6c9c846c266d8a466ed05c2.png)
